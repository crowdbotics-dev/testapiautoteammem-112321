...
## Project Structure
    ...
    ├── testapiautoteammem_112321  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_112321`
...
2. Clone this repo and `cd testapiautoteammem_112321`
